...
import com.group2.kelem.services.MyUserDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers("/user-photos/**/*").hasAnyRole("ADMIN", "MEMBER") // find better way
                ...
                .antMatchers("/admin", "/add-admin", "/reported-answers", "/resolve-report/{id}",
                             ...
                             "/ques-dismiss-report/{id}").hasRole("ADMIN")
